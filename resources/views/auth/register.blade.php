...
<div class="form-page register-form" id="registerFormStep2">
    ...
    <div id="pdf-data-preview">
        <div class="pdf-data-title">Datos Verificados</div>
        <div class="pdf-data-grid">
            <div class="pdf-data-item">
                <span class="pdf-data-label">Nombre</span>
                <div class="pdf-data-value" id="pdf-name">Juan Pérez</div>
            </div>
            <div class="pdf-data-item">
                <span class="pdf-data-label">RFC</span>
                <div class="pdf-data-value" id="pdf-rfc">PERJ800101</div>
            </div>
            <div class="pdf-data-item">
                <span class="pdf-data-label">Fecha de Emisión</span>
                <div class="pdf-data-value" id="pdf-date">01/01/2023</div>
 Microsoft Word - 20210413_SAT_Constancia.docx
            </div>
            <div class="pdf-data-item">
                <span class="pdf-data-label">Régimen</span>
                <div class="pdf-data-value" id="pdf-regimen">Persona Física</div>
            </div>
        </div>
    </div>
